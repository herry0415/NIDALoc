...
parser.add_argument('--log_dir', default=f'/data/drj/Snail_Radar_weights/NIDALoc_{SEQUENCE_NAME}_Radar/',
...
parser.add_argument('--resume_model', type=str, default='checkpoint_epoch95.tar',
