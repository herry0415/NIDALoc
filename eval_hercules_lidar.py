...
parser.add_argument('--log_dir', default=f'NIDALoc_{SEQUENCE_NAME}_Lidar/',
...
def valid_one_epoch(model, val_loader, val_writer, device):
    ...
    image_filename = os.path.join(os.path.expanduser(FLAGS.log_dir), f'epoch_{args["resume_epoch"]}_lidar_{SEQUENCE_NAME}.png') #todo 注意改radar/lidar
